 ...
 */
public class MyASMifier extends MyPrinter {
    ...
    /**
     * Constructs a new {@link MyASMifier}. <i>Subclasses must not use this constructor</i>. Instead,
     * they must use the {@link #MyASMifier(int, String, int)} version.
     *
     * @throws IllegalStateException If a subclass calls this constructor.
     */
    public MyASMifier() {
        this(/* latest api = */ Opcodes.ASM9, "classWriter", 0);
        if (getClass() != MyASMifier.class) {
            throw new IllegalStateException();
        }
    }

    /**
     * Constructs a new {@link MyASMifier}.
     *
     ...
     */
    protected MyASMifier(final int api, final String visitorVariableName, final int annotationVisitorId) {
        super(api);
    ...
    static void main(final String[] args, final PrintWriter output, final PrintWriter logger) throws IOException {
        MyPrinter.main(args, USAGE, new MyASMifier(), output, logger);
    }
    ...
    @Override
    public MyPrinter visitModule(final String name, final int flags, final String version) {
        stringBuilder.setLength(0);
        stringBuilder.append("{\n");
        ...
        stringBuilder.append(END_PARAMETERS);
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier("moduleVisitor", 0);
    ...
    @Override
    public MyASMifier visitClassAnnotation(final String descriptor, final boolean visible) {
        return visitAnnotation(descriptor, visible);
    }

    @Override
    public MyASMifier visitClassTypeAnnotation(
    ...
    @Override
    public MyASMifier visitRecordComponent(
        ...
        stringBuilder.append(");\n");
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier("recordComponentVisitor", 0);
        text.add(asmifier.getText());
        text.add("}\n");
        return asmifier;
    }
    ...
    public MyASMifier visitField(
        ...
        stringBuilder.append(");\n");
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier("fieldVisitor", 0);
        text.add(asmifier.getText());
        text.add("}\n");
        return asmifier;
    }
    ...
    public MyASMifier visitMethod(
        ...
        stringBuilder.append(");\n");
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier("methodVisitor", 0);
        text.add(asmifier.getText());
        text.add("}\n");
        return asmifier;
    }
    ...
    @Override
    public MyASMifier visitAnnotation(final String name, final String descriptor) {
        stringBuilder.setLength(0);
        stringBuilder
                .append("{\n")
        ...
        stringBuilder.append(");\n");
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier(ANNOTATION_VISITOR, id + 1);
        text.add(asmifier.getText());
        text.add("}\n");
        return asmifier;
    }
    ...
    @Override
    public MyASMifier visitArray(final String name) {
        stringBuilder.setLength(0);
        stringBuilder.append("{\n");
        stringBuilder
                .append("AnnotationVisitor annotationVisitor")
    ...
    @Override
    public MyASMifier visitRecordComponentAnnotation(final String descriptor, final boolean visible) {
        return visitAnnotation(descriptor, visible);
    }

    @Override
    public MyASMifier visitRecordComponentTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, descriptor, visible);
    }
    ...
    @Override
    public MyASMifier visitFieldAnnotation(final String descriptor, final boolean visible) {
        return visitAnnotation(descriptor, visible);
    }

    @Override
    public MyASMifier visitFieldTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, descriptor, visible);
    }
    ...
    @Override
    public MyASMifier visitAnnotationDefault() {
        stringBuilder.setLength(0);
        stringBuilder
                .append("{\n")
        ...
        text.add(stringBuilder.toString());
        MyASMifier asmifier = createASMifier(ANNOTATION_VISITOR, 0);
        text.add(asmifier.getText());
        text.add("}\n");
        return asmifier;
    }
    ...
    @Override
    public MyASMifier visitMethodAnnotation(final String descriptor, final boolean visible) {
        return visitAnnotation(descriptor, visible);
    }

    @Override
    public MyASMifier visitMethodTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, descriptor, visible);
    }

    @Override
    public MyASMifier visitAnnotableParameterCount(final int parameterCount, final boolean visible) {
        stringBuilder.setLength(0);
        stringBuilder
                .append(name)
    ...
    @Override
    public MyASMifier visitParameterAnnotation(
    ...
    @Override
    public MyASMifier visitInsnAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
    ...
    @Override
    public MyASMifier visitTryCatchAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
    ...
    @Override
    public MyPrinter visitLocalVariableAnnotation(
            final int typeRef,
     ...
     * @return a new {@link MyASMifier} to visit the annotation values.
     */
    // DontCheck(OverloadMethodsDeclarationOrder): overloads are semantically different.
    public MyASMifier visitAnnotation(final String descriptor, final boolean visible) {
        stringBuilder.setLength(0);
        stringBuilder
                .append("{\n")
                .append(ANNOTATION_VISITOR0)
     ...
     * @return a new {@link MyASMifier} to visit the annotation values.
     */
    public MyASMifier visitTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
     ...
     * @param visitorVariableName the name of the visitor variable in the produced code.
     * @param annotationVisitorId identifier of the annotation visitor variable in the produced code.
     * @return a new {@link MyASMifier}.
     */
    // DontCheck(AbbreviationAsWordInName): can't be renamed (for backward binary compatibility).
    protected MyASMifier createASMifier(
            final String visitorVariableName, final int annotationVisitorId) {
        return new MyASMifier(api, visitorVariableName, annotationVisitorId);
    }
