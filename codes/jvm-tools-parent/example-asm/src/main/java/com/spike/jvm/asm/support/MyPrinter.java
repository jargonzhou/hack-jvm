...
/**
 * @see org.objectweb.asm.util.Printer
 */
public abstract class MyPrinter extends Printer {
    ...
    /**
     * Constructs a new {@link MyPrinter}.
     *
     * @param api the ASM API version implemented by this MyPrinter. Must be one of the {@code
     *            ASM}<i>x</i> values in {@link Opcodes}.
     */
    protected MyPrinter(final int api) {
        super(api);
        this.api = api;
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitModule(final String name, final int access, final String version) {
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitClassAnnotation(String descriptor, boolean visible);
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitClassTypeAnnotation(
     ...
     */
    public MyPrinter visitRecordComponent(
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitField(
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitMethod(
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitAnnotation(String name, String descriptor);
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitArray(String name);
     ...
     */
    public MyPrinter visitRecordComponentAnnotation(final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * interested in visiting this annotation.
     */
    public MyPrinter visitRecordComponentTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitFieldAnnotation(String descriptor, boolean visible);
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitFieldTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitAnnotationDefault();
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitMethodAnnotation(String descriptor, boolean visible);
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitMethodTypeAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitAnnotableParameterCount(final int parameterCount, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @return the MyPrinter.
     */
    public abstract MyPrinter visitParameterAnnotation(
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitInsnAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @return the MyPrinter.
     */
    public MyPrinter visitTryCatchAnnotation(
            final int typeRef, final TypePath typePath, final String descriptor, final boolean visible) {
        throw new UnsupportedOperationException(UNSUPPORTED_OPERATION);
    }
     ...
     * @param printer the MyPrinter to convert the class into text.
